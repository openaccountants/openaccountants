...
1. `foundation.md`
2. `intake.md`
3. `netherlands-30-percent-ruling.md`
4. `netherlands-bookkeeping.md`
5. `netherlands-crypto-tax.md`
6. `netherlands-financial-statements.md`
7. `netherlands-formation.md`
8. `netherlands-owner-occupied-home-tax-scheme.md`
9. `netherlands-payroll.md`
10. `netherlands-tax-optimization.md`
11. `netherlands-transfer-pricing.md`
12. `netherlands-vat-return.md`
13. `nl-30-percent-ruling.md`
14. `nl-corporate-tax.md`
15. `nl-deductions.md`
16. `nl-income-tax.md`
17. `nl-payroll-tax.md`
18. `nl-tax-objection.md`
19. `nl-vat-return.md`
20. `nl-zzp-deductions.md`
21. `references.md`
