---
name: travel-allowance-and-logbook-rate-tables-2023-to-2027
description: The SARS fixed cost table and prescribed rate per kilometre, keyed by year of assessment 2023 to 2027, with the method for a deemed-cost travel claim.
jurisdiction: ZA
...
**Year of assessment labelling table**  _(SARS numbers a year of assessment by the calendar year in which it ends)_
...
## Section 2 — Fixed cost table ([SARS Rate per Kilometre Schedule, PAYE-GEN-01-G03-A01](https://www.sars.gov.za/wp-content/uploads/Docs/PAYE/Tables/tables2026/PAYE-GEN-01-G03-A01-Rate-per-Kilometre-Schedule-External-Annexure.pdf))
...
**Fixed cost table — YoA 2023 (2022/23)**  _(Source: SARS Fixed Cost Table, YoA 2023, published under Income Tax Act s 8(1)(b)(iii) as PAYE-GEN-01-G03-A01. Annexure for this year not retrievable; not independently confirmed.)_
...
**Fixed cost table — YoA 2024 (2023/24)**  _(Source: SARS Fixed Cost Table, YoA 2024, published under Income Tax Act s 8(1)(b)(iii) as PAYE-GEN-01-G03-A01. Annexure for this year not retrievable; not independently confirmed.)_
...
**Fixed cost table — YoA 2025 (2024/25)**  _(Source: SARS Fixed Cost Table, YoA 2025, published under Income Tax Act s 8(1)(b)(iii) as PAYE-GEN-01-G03-A01. Confirmed 2026-09-02 against PAYE-GEN-01-G03-A01, Revision 17, effective 29 February 2024 — all 9 bands.)_
...
**Fixed cost table — YoA 2026 (2025/26)**  _(Source: SARS Fixed Cost Table, YoA 2026, published under Income Tax Act s 8(1)(b)(iii) as PAYE-GEN-01-G03-A01. Annexure for this year not retrievable; not independently confirmed.)_
...
**Fixed cost table — YoA 2027 (2026/27)**  _(Source: SARS Fixed Cost Table, YoA 2027, published under Income Tax Act s 8(1)(b)(iii) as PAYE-GEN-01-G03-A01. Confirmed 2026-09-02 against PAYE-GEN-01-G03-A01, Revision 19, effective 1 March 2026 — all 9 bands.)_
...
1. **Establish the vehicle's determined value first.** Not market value, not the trade-in
   price — the determined value as defined in the schedule. It sets which band you are in,
   and every other figure follows from it.
2. **Pick the table for the correct year of assessment.** The bands themselves change, not
   just the amounts: the YoA 2027 table moved from R100,000 steps to R115,000 steps. Reading
   the right value out of the wrong year's band structure is the easiest error here.
3. **Read all three figures off the same row** — fixed cost, fuel, maintenance. Do not
   assume a row duplicates the one above it, including the open top band.
4. **Apportion the fixed cost where the vehicle was not held for the full year**, in the
   ratio the period of use bears to 365 days. Fuel and maintenance are per kilometre and
   are not apportioned.
5. **Apply fuel and maintenance only where the taxpayer actually bore that cost.** If the
   employer paid for fuel, the fuel cost falls away; the same for maintenance.
6. **Then, and only then, apply business kilometres from the logbook.** No logbook, no
   claim — the deemed-cost method still requires the record of business travel.

**What breaks when the order is wrong.** Applying the business-kilometre ratio before
apportioning the fixed cost double-counts the reduction. Taking fuel cost where the employer
bore it overstates the claim outright. And carrying a prior year's band structure forward
puts the taxpayer in the wrong row before any arithmetic starts.
